...
private:
    ...
    void EnsureCapacity( int cap ) {
        ...
        if ( cap > _allocated ) {
			...
			memset( newMem, 0x00, sizeof(T)*newAllocated );
...
public:
    ...
    /** Given Element, returns the value
		of the XMLElement interpreted in string  
		has a const char*.
    */
	char* CStr() ;
	int CStrSize();

	/** Print the Element. If the Printer is not provided, it will
